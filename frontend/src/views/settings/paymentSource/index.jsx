        ...
        <Grid container spacing={gridSpacing}>
            <Grid item xs={12} sm={12} md={4}>
                <Card variant="outlined">
                    ...
                    <CardContent>
                        {checkRestriction('CAN_ADD_PAYMENT_SOURCE') ? (
                            <AddEditPaymentSource formID="addPaymentSource" onSubmit={submitHandler} />
                        ) : (
                            <Typography
                                sx={{
                                    p: '8%'
            ...
            <Grid item xs={12} sm={12} md={8}>
                <MainCard
                            ...
                            <Grid item xs={12}>
                                <Grid container spacing={gridSpacing}>
                                    <Grid item sx={{ flexGrow: 1 }}>
                                        <Typography variant="column">Payment Source List</Typography>
                                    </Grid>
                                    <Grid item>
                                        <OutlinedInput
                    ...
                    content={true}
                >
                    <PaymentSourceList search={search} callApi={callApi} />
                </MainCard>
            </Grid>
        </Grid>
    );
