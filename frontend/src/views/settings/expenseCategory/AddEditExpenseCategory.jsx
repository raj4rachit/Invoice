...
import { AddUpdateExpenseCategoryApi } from 'apis/Settings';
...
const AddEditExpenseCategory = ({ value, formID, onSubmit, initData }) => {
    ...
    const formik = useFormik({
        ...
        onSubmit: (values, { resetForm }) => {
            AddUpdateExpenseCategoryApi(values)
                .then((res) => {
...
AddEditExpenseCategory.propTypes = {
