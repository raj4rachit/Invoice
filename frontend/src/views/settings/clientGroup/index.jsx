        ...
        <Grid container spacing={gridSpacing}>
            <Grid item xs={12} sm={12} md={4}>
                <Card variant="outlined">
                    <CardHeader title="Add Client Group" />
                    <CardContent>
                        {checkRestriction('CAN_ADD_CLIENT_GROUP') ? (
                            <AddEditClientGroup formID="addClientGroup" onSubmit={submitHandler} />
                        ) : (
                            <Typography
                                sx={{
                                    p: '8%'
            ...
            <Grid item xs={12} sm={12} md={8}>
                <MainCard
                            ...
                            <Grid item xs={12}>
                                <Grid container spacing={gridSpacing}>
                                    <Grid item sx={{ flexGrow: 1 }}>
                                        <Typography variant="column">Client Group List</Typography>
                                    </Grid>
                                    <Grid item>
                                        <OutlinedInput
                    ...
                    content={true}
                >
                    <ClientGroupList search={search} callApi={callApi} />
                </MainCard>
            </Grid>
        </Grid>
    );
