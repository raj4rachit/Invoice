        ...
        <Grid container spacing={gridSpacing}>
            <Grid item xs={12} sm={12} md={4}>
                <Card variant="outlined">
                    ...
                    <CardContent>
                        <AddEditDocumentType formID="addSourcePlatform" onSubmit={submitHandler} />
                    </CardContent>
                </Card>
            </Grid>
            <Grid item xs={12} sm={12} md={8}>
                <MainCard
                            ...
                            <Grid item xs={12}>
                                <Grid container spacing={gridSpacing}>
                                    <Grid item sx={{ flexGrow: 1 }}>
                                        <Typography variant="column">Document Type List</Typography>
                                    </Grid>
                                    <Grid item>
                                        <OutlinedInput
                    ...
                    content={true}
                >
                    <DocumentTypeList search={search} callApi={callApi} />
                </MainCard>
            </Grid>
        </Grid>
    );
