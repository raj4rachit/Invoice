...
import { DeleteCompanyBankApi, DeleteDocumentTypeApi, deleteSourcePlatformApi, DocumentTypeListApi } from 'apis/Settings';
...
let recordsTotal = 0;
const DocumentTypeList = ({ search, callApi }) => {
    ...
    const deleteHandler = () => {
        DeleteDocumentTypeApi({ id: DocumentTypeData.id })
            .then((res) => {
        ...
        <>
            ...
            {openEdit && (
                <CenterDialog
                    ...
                    id="editDocumentType"
                >
                    <AddEditDocumentType value={DocumentTypeData} formID="editDocumentType" onSubmit={submitHandler} />
                </CenterDialog>
            )}
