        ...
        <Box>
            <form id={formId} onSubmit={formik.handleSubmit}>
                <Grid container spacing={2}>
                    ...
                    {console.log(formik.values.contribute_by)}
                    {console.log(initData.sourceBy.filter((a) => formik.values.contribute_by.some((b) => a.id === b)))}
                    <Grid item xs={12}>
                        <Grid container alignItems="center" spacing={2}>
                            <Grid item xs={12} sm={4}>
                                <Typography variant="subtitle1">Contribute By</Typography>
                            </Grid>
                            <Grid item xs={12} sm={8}>
                                <Autocomplete
                                    multiple
