...
import { AddUpdateIncomesApi, SubcategoryListApi } from 'apis/Incomes';
...
const validationSchema = yup.object().shape({
    ...
    incomes_title: yup.string().required('Title is required.'),
    date: yup.date().required('Date is required.'),
    amount: yup.string().required('Amount is required.')
});

const AddEditIncomes = ({ value, formID, onSubmit, initData }) => {
    ...
    const formik = useFormik({
        initialValues: {
            ...
            incomes_title: initValue ? initValue.title : '',
                    ...
                    <Grid container alignItems="center" spacing={2}>
                        ...
                        <Grid item xs={12} sm={12}>
                            <TextField
                                ...
                                value={formik.values.incomes_title}
                                onChange={formik.handleChange}
                                error={formik.touched.incomes_title && Boolean(formik.errors.incomes_title)}
                                helperText={formik.touched.incomes_title && formik.errors.incomes_title}
                            />
                        </Grid>
