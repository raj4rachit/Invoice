    ...
    return (
        <>
                        ...
                        <Grid item xs={12}>
                            <Grid container alignItems="center" spacing={gridSpacing}>
                                <Grid item sx={{ flexGrow: 1 }}>
                                    <Typography variant="column">Incomes List</Typography>
                                </Grid>
                                <Grid item>
                                    <ButtonBase
                                        disableRipple
                                ...
                                {checkRestriction('CAN_ADD_INCOMES') && (
                                    <Grid item>
                                        <Button variant="contained" onClick={() => addData()}>
                                            <AddCircleOutlineOutlined sx={{ mr: 0.5 }} /> Add Incomes
                                        </Button>
                                    </Grid>
                                )}
                                <Grid item>
            ...
            >
                ...
                <IncomesList search={search} callApi={callApi} filter={filter} setInitData={setInitData} initData={initData} />
            </MainCard>

            {/* {openAdd && (
                <CenterDialog title={`Add Incomes`} open={openAdd} onClose={() => setOpenAdd((prevState) => !prevState)} id="addIncomes">
                    <AddEditIncomes formID="addIncomes" onSubmit={submitHandler} initData={initData} />
                </CenterDialog>
            )} */}
            {openAdd && (
                <CommonDialog title={`Add Incomes`} open={openAdd} onClose={() => setOpenAdd((prevState) => !prevState)} id="addIncomes">
                    <AddIncomes formID="addIncomes" onSubmit={submitHandler} initData={initData} />
                </CommonDialog>
            )}
        </>
    );
