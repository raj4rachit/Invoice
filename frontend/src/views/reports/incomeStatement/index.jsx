...
import { IncomeStatementApi, InitIncomeStatementApi } from 'apis/Reports';
    ...
    const generateExportReport = () => {
        ...
        IncomeStatementApi(values)
            .then((res) => {
                ...
                a.href = res.data.data.incomes;
                a.download = res.data.data.income_name;
                a.click();
            })
            .catch((err) => {
                console.error(err);
                        ...
                        <Grid item xs={12}>
                            <Grid container alignItems="center" spacing={gridSpacing}>
                                <Grid item sx={{ flexGrow: 1 }}>
                                    <Typography variant="column">Income Statement</Typography>
                                </Grid>
                                <Grid item>
